...
!(function (e, t) {
    ...
    function m(e, t) {
      var n = s("div", "numInputWrapper"),
        a = s("input", "form-control numInput shadow-none " + e),
        i = s("span", "arrowUp"),
        o = s("span", "arrowDown")
      if (
    ...
    function E(p, v) {
      ...
      function H(e, t, n, a) {
        var i = X(t, !0),
          o = s("span", "cal-btn " + e, t.getDate().toString())
        return (
          (o.dateObj = t),
          (o.$i = a),
          ...
          w.weekNumbers &&
            ...
            w.weekNumbers.insertAdjacentHTML(
              "beforeend",
              "<span class='cal-btn'>" + w.config.getWeek(t) + "</span>"
            ),
          pe("onDayCreate", o),
          o
        )
      ...
      function B(e, t) {
        ...
        for (
          var f = i + 1;
          f <= dayInCal - n && (1 === w.config.showMonths || u % 7 != 0);
          f++, u++
        )
      ...
      function U() {
        ...
        w.config.showMonths > 1 || "static" === w.config.monthSelectorType
          ...
          : ((w.monthsDropdownContainer = s(
              "select",
              "form-select cal-month-name shadow-none"
            )),
      ...
      function $() {
        w.weekdayContainer
          ...
          : (w.weekdayContainer = s("div", "cal-weekdays text-muted"))
        // for (var e = w.config.showMonths; e--; ) {
      ...
      function z() {
        if (w.weekdayContainer) {
          ...
          //for (var a = w.config.showMonths; a--; )
            w.weekdayContainer.innerHTML =
              "\n      <div class='cal-weekday'>\n        " +
              n.join("</div><div class='cal-weekday'>") +
              "\n      </div>\n      "
        }
      }
      function G(e, t) {
      ...
      function ae(e) {
        if (
          1 === w.selectedDates.length &&
          (!e ||
            (e.classList.contains("cal-btn") &&
              !e.classList.contains("flatpickr-disabled")))
        ) {
          for (
            var t = e
                ? e.dateObj.getTime()
                : w.days.dateObj.getTime(),
          ...
          ;(w.element = w.input = p),
            ...
            w.isMobile ||
              (function () {
                ...
                if (
                  ((w.calendarContainer = s("div", "flatpickr-calendar p-2")),
                  (w.calendarContainer.tabIndex = -1),
                  !w.config.noCalendar)
                ) {
                  if (
                    (e.appendChild(
                      ((w.monthNav = s("div", "cal-month")),
                      (w.yearElements = []),
                      (w.monthElements = []),
                      (w.prevMonthNav = s("button", "btn cal-btn shadow-none")),
                      (w.prevMonthNav.innerHTML = w.config.prevArrow),
                      (w.nextMonthNav = s("button", "btn cal-btn shadow-none")),
                  ...
                  ;(w.rContainer = s("div", "flatpickr-rContainer")),
                    e.appendChild($())
                    w.daysContainer ||
                      ((w.daysContainer = s("div", "cal-days")),
                      (w.daysContainer.tabIndex = -1)),
                    J(),

                    //w.rContainer.appendChild(w.daysContainer),
                    //w.innerContainer.appendChild(w.rContainer)
                    e.appendChild(w.daysContainer)
                }
                w.config.enableTime &&
                  e.appendChild(
                    (function () {
