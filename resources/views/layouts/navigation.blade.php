<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('menuboards*') ? 'active' : '' }}" href="{{ route('menuboard.index') }}">
        ...
        <ul class="nav flex-column mb-2">
            <li class="nav-item">
                <a class="nav-link {{ Request::is('nomenclature*') ? 'active' : '' }}" href="{{ route('nomenclature.index') }}">
        ...
        @if((int) Auth::user()->role === App\Models\User::ROLE_ADMIN)
            ...
            <ul class="nav flex-column mb-2">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ (Request::is('admin/users*') && !Request::is('admin/users/reports*') && !Request::is('admin/users/menuboards*')) ? 'active' : '' }}" href="{{ route('admin.user.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/users/menuboards*') ? 'active' : '' }}" href="{{ route('admin.user.menuboard.index') }}">
                        <span data-feather='tv'></span>
                        Пользовательские менюборды
                    </a>
                </li>
            </ul>
        @endif
